...
------------------------------------------------------------------------------------------------
v.1.2.0		- Added another sheet to 'Toolkit.numbers' to emulate 'PocketDCF.py'; this version requires the original 'Sheet:Valuation' to be filled in.
		- The addition is to make the calculation faster if you want to use 'Sheet:Valuation' for your forecasted values, otherwise 'PocketDCF.sh' offers more flexibility.
		- Updated 'README.txt' accordingly to suit new features.
...
1.2.	It is recommended to rename parent folder to something simple like 'PocketAnalyst'

2.0. 	Populate yellow boxes in Numbers file.
2.1. 	For growth rate, if you do not have an exact value it’s recommended to look at industry wide averages. I recommend Dr. Damodaran’s sector CAGRS: https://pages.stern.nyu.edu/~adamodar/New_Home_Page/datafile/histgr.html
2.2. 	Please use figures in millions where requested to.
2.3.	WACC sheet allows you to calculate WACC and forecast values including a terminal Enterprise Value.
2.4.	WACC sheet requires Valuation sheet to be filled in completely; Crocs, Inc. is used as an example in the spreadsheet by default.
2.5.	If you want more freedom in the inputs as well as the amount of forecast periods, use PocketDCF.
